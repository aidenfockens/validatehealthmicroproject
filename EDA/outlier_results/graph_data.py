...
csv_files = [
    "outliers_all.csv",
    "outliers_betos_cd_T1H_pos_cd_81_spec_cd_69.csv",
    "outliers_betos_cd_T1H_pos_cd_81.csv",
    "outliers_betos_cd_T1H_spec_cd_69.csv",
    "outliers_betos_cd_T1H.csv",
    "outliers_pos_cd_81_spec_cd_69.csv",
    "outliers_pos_cd_81.csv",
    "outliers_spec_cd_69.csv"
]
...
for i, csv_file in enumerate(csv_files):
    ...
    plt.plot(df['service_week'], df['total_metric'], marker='o', linestyle='-', label=csv_file, color=colors[i])
