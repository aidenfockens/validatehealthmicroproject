...
plt.plot(df['service_week'], df['total_metric'], marker='o', linestyle='-', label="Total Paid Amount", color='black')

# Fill the acceptable range area (shaded region)
plt.fill_between(df['service_week'], df['lower_bound'], df['upper_bound'], color='gray', alpha=0.3, label="Acceptable Range (±2 Std Dev)")
...
plt.scatter(outliers_z['service_week'], outliers_z['total_metric'], color='red', label="Z-Score Outliers", zorder=3)
plt.scatter(outliers_count['service_week'], outliers_count['total_metric'], color='blue', label="Count-Based Outliers", zorder=3)
plt.scatter(outliers_metric['service_week'], outliers_metric['total_metric'], color='green', label="Metric-Based Outliers", zorder=3)
plt.scatter(outliers_multiple['service_week'], outliers_multiple['total_metric'], color='purple', label="Multiple Outlier Conditions", zorder=3)
